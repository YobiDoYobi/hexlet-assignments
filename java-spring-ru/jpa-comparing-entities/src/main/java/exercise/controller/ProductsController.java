...
public class ProductsController {
    ...
    public Product create(@RequestBody Product product) {
        //List<Product> finded = productRepository.findByTitleAndPrice(product.getTitle(), product.getPrice());
        productRepository.findByTitleAndPrice(product.getTitle(), product.getPrice())
                .ifPresent(p -> {
